...
robotAttr, entityAttr, plantAttr, flowerAttr, copperAttr, snowAttr, rockAttr, baseAttr, fireAttr, woodAttr, deviceAttr, dirtAttr, grassAttr, stoneAttr, waterAttr, iceAttr, highlightAttr, sepAttr, infoAttr, defAttr
  :: AttrName
dirtAttr = "dirt"
grassAttr = "grass"
stoneAttr = "stone"
